...
function register_submit(){
   ...
   if(mobile==""){
         $('#mobile_error').html("Enter your mobile");
       is_error='yes';
       }
   if(password==""){
        ...
        jQuery.ajax({
            ...
            if(result=='email_present'){
                ...
                if(result=='email_insert'){
                 $('.register_msg p').html("Successfully Registered");
            }
        }
...
function  sort_product(cat_id,sort_path){
     var sort_product_id= jQuery("#sort_product_id").val();
 window.location.href=sort_path+"categories.php?Id="+cat_id+"&sort="+sort_product_id;
